-- Reconcile household role permissions for projects that already ran the
-- original 20260912 household migrations. This migration is intentionally
...
-- Pets: all household roles can view; only owners can create or edit.
...
-- Documents and medical events: caregivers may view, owners manage.
...
-- Medication definitions and schedules are owner-managed.
...
-- Caregivers may manage care tasks; sitters may view and complete them only.
...
-- AI-derived medical data inherits the document's medical permissions.
...
-- Private veterinary files follow the same medical visibility rules.
